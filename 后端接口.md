...
**接口地址**: `GET /admin/user/leaderList`

**接口描述**: 管理员获取所有负责人列表

**请求参数**: 无

**请求示例**: `GET /admin/user/leaderList`
...
**接口地址**: `GET /admin/activity/{id}`

**接口描述**: 管理员根据活动 ID 获取活动详细信息
...
**响应示例**: 同 2.5（仅返回当前负责人创建的活动）

### 3.4 根据活动 ID 获取活动信息

**接口地址**: `GET /leader/activity/{id}`

**接口描述**: 负责人根据活动 ID 获取活动详细信息
...
2. `GET /admin/user/leaderList` - 获取所有负责人列表
3. `PUT /admin/user/update` - 更新用户信息
4. `GET /admin/user/{id}` - 根据 ID 查询用户信息
5. `GET /admin/activity/list` - 获取所有活动信息
6. `GET /admin/activity/{id}` - 根据活动 ID 获取活动信息
7. `PUT /admin/activity/update` - 更新活动信息
...
4. `GET /leader/activity/{id}` - 根据活动 ID 获取活动信息
5. `PUT /leader/activity/update` - 更新活动
6. `DELETE /leader/activity/delete` - 删除活动
7. `GET /leader/activity/signupRecords` - 获取报名记录
8. `PUT /leader/activity/audit` - 审核报名
9. `POST /leader/activity/taskAssign` - 任务分配
10. `GET /leader/activity/taskList` - 获取任务列表
11. `GET /leader/activity/userList` - 获取活动报名成功的用户列表
